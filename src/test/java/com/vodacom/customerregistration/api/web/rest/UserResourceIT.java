...
import com.vodacom.customerregistration.api.repository.search.UserSearchRepository;
...
import com.vodacom.customerregistration.api.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    void createUser() throws Exception {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.AGENT));
    ...
    void testUserEquals() throws Exception {
        ...
        user2.setId(UUID.fromString("21111111-1111-1111-1111-111111111111"));
